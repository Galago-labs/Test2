 ...
 *
 * ONE THING YOU MUST CHANGE BEFORE A REAL RELEASE (not before testing — see
 * AD_UNIT_ID below, which currently holds Yandex's safe official demo ID):
 *  Replace AD_UNIT_ID with your real interstitial ad unit id from
...
class YandexAdsPlugin : Plugin() {
    ...
    companion object {
        ...
        // Yandex's own official demo ad unit ID — guaranteed to always return a
        // real test ad, confirmed current at
        // https://ads.yandex.com/helpcenter/en/dev/android/interstitial ("Using
        // demo ad units for ad testing"). Safe to tap on your own device: it's
        // not tied to your account, so it can't get you flagged for invalid
        // traffic the way tapping a REAL ad on your own app would.
        //
        // BEFORE A REAL RELEASE: replace this with your real interstitial ad
        // unit id from ads.yandex.com/monetization (your app -> Ad units ->
        // New ad unit -> Interstitial — real IDs look like R-M-1234567-8). That
        // string is what ties an impression back to your account for crediting.
        // Nothing else in this file needs to change either way.
        private const val AD_UNIT_ID = "demo-interstitial-yandex"
    }
